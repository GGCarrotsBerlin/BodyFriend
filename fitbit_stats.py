...
fitbit_activity_summary='In general, you were {option}. \n Some stats for you: total distance:<b>{td}</b>, lightly active minutes:<b>{am}</b>, sedentary minutes:<b>{sm}</b>. '.format(
